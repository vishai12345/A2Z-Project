...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2017 at 05:22 PM
...
CREATE TABLE `messages` (
  ...
  `regarding_sub` varchar(111) NOT NULL,
  `postal_code` varchar(111) NOT NULL,
...
(275, 252, 'vishal happy', 134, 'maths', '486002', '', 0, '3gapkHOaWKMWWjy6S1vjQLqp2BYf27vQ5QiNOQwW', '2017-02-18 09:12:22', '2017-02-18 09:12:22');
...
(252, 'vishal happy', 'vishal', 'happy', 'vc12edcs1365@gmail.com', '9876543210', '$2y$10$CouPZ8y97aghEp3rs/Acf.45YAP4LAwICXEJDwTZQ5eZyedudPFYi', 'student', 1, NULL, NULL, 'BjM0dPa5YQ5qSOy1ecY7Oo62kvoNkdWY8a714BH0JcTMbStrmDp2ggJZo6Bm', '2017-02-17 05:31:50', '2017-02-18 04:11:31'),
(253, 'vishal happy', 'vishal', 'happy', 'vc1fv21356@gmail.com', '9876543210', '$2y$10$VHWzjslZahMorHX.GJLBreX3DOYTUb6Y5RNK450awVAB9Md2C7fMu', 'student', 1, NULL, NULL, 'cPm5YJ7bO3nTlIhvNwsdJ4y4W9Ag14JypvICZPgsQfaAHHS4g3CbPmKCobuO', '2017-02-17 05:35:39', '2017-02-17 10:36:57');
...
--
ALTER TABLE `messages`
  MODIFY `id` int(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=276;
--
