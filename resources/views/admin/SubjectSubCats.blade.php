            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools pull-right">
                        {{ Html::link('admin/SubjectSubCat-Entry', 'Add New', array('class' => 'btn btn-primary btn-xs'))}}
                    </div>
                </div>
                        ...
                        <table class="table table-striped stock_table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $subject->sub_cat_name}}</td>
									 <td>{{ $subject->category_name}}</td>
                                    
                                    <td>
                                        {{ HTML::link('admin/Edit-SubjectSubCat/'.$subject->id, '', 
										array('class' => 'btn btn-primary btn-xs fa fa-pencil'))}}
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        {{ HTML::link('admin/Delete-SubjectSubsCat/'.$subject->id, '',
